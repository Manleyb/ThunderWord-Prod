  ...
  <footer id="footer">
    <div class="container">
      <div class="row d-flex align-items-center">
        ...
        <div class="col-lg-6 text-lg-right text-center pt-3 pt-lg-0">
          <a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/img/logo-hc.png" alt="" class="img-fluid" style="width:200px;"></a>
        </div>
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/vendor/counterup/counterup.min.js"></script>
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/vendor/venobox/venobox.min.js"></script>
